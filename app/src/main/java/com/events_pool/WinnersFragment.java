...
public class WinnersFragment extends Fragment {
    ...
    private Button madd_winner_btn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        madd_winner_btn=view.findViewById(R.id.add_winners);
        ...
        rootRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChild("admin")){
                    ...
                    madd_winner_btn.setVisibility((View.VISIBLE));
                    madd_winner_btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {

                            startActivity(new Intent(getContext(),PostWinnersActivity.class));
                        }
                    });
                }else{


                    madd_winner_btn.setVisibility(View.INVISIBLE);
